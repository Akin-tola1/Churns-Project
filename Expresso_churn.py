...
st.markdown("<h4 style = 'margin: -30px; color: #F11A7B; text-align: center; font-family: cursive '>Built By DEJI</h4>", unsafe_allow_html = True)
st.image('pngwing.com (7).png', width = 350, use_column_width = True )
